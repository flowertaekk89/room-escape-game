...
public class Room {
	...
	public Room(int no, int map_no, String master_id, String title, String room_pw, int numberOfUsers, String status) {
		super();
		this.no = no;
		this.map_no = map_no;
	...
	public String toString() {
		return "Room [no=" + no + ", map_no=" + map_no + ", master_id=" + master_id + ", title=" + title + ", room_pw="
				+ room_pw + ", numberOfUsers=" + numberOfUsers + ", status=" + status + ", profile=" + profile + "]";
	}
